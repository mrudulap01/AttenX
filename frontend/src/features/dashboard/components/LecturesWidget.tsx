...
import { mockLecturesToday } from '../api/mockData';
...
export const LecturesWidget = () => {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 h-full flex flex-col">
      <h3 className="text-lg font-semibold text-gray-800 mb-4 tracking-tight">Today's Schedule</h3>
      <div className="space-y-3 flex-grow overflow-auto pr-2 custom-scrollbar">
        {mockLecturesToday.map((lecture) => (
